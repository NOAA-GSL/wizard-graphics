import { distance } from './geodesy.ts';
        ...
        ...(viewport.width > viewport.height
            ? [
                  ...
                  distance(
                      viewportGlobeCenter,
                      viewport.unproject([
                          viewport.width / 2 - (viewport.height / 2) * 1,
                          viewport.height / 2,
                      ]),
                  ),
                  distance(
                      viewportGlobeCenter,
                      viewport.unproject([
                          viewport.width / 2 - (viewport.height / 4) * 3,
                          viewport.height / 2,
                      ]),
                  ),
                  distance(
            ...
            : [
                  distance(
                      ...
                      viewport.unproject([
                          viewport.width / 2,
                          viewport.height / 2 - (viewport.width / 4) * 1,
                      ]),
                  ),
                  distance(
                      viewportGlobeCenter,
                      viewport.unproject([
                          viewport.width / 2,
                          viewport.height / 2 - (viewport.width / 2) * 1,
                      ]),
                  ),
                  distance(
                      viewportGlobeCenter,
                      viewport.unproject([
                          viewport.width / 2,
                          viewport.height / 2 - (viewport.width / 4) * 3,
                      ]),
                  ),
                  distance(
                      viewportGlobeCenter,
                      viewport.unproject([
                          viewport.width / 2,
                          viewport.height / 2 - viewport.width,
                      ]),
                  ),
              ]),
    );
